...
static class MDFUNC32
{
	...
	[DllImport("MDFUNC32.DLL", EntryPoint = "mddevrst", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
	public static extern short mdDevRst(int Path, short Stno, short Devtyp, short devno);
	[DllImport("MDFUNC32.DLL", EntryPoint = "mdrandw", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
	public static extern short mdRandW(int Path, short Stno, ref short dev, ref short buf, short bufsiz);
	[DllImport("MDFUNC32.DLL", EntryPoint = "mdrandr", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
	public static extern short mdRandR(int Path, short Stno, ref short dev, ref short buf, short bufsiz);
	[DllImport("MDFUNC32.DLL", EntryPoint = "mdcontrol", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
	public static extern short mdControl(int Path, short Stno, short buf);
	[DllImport("MDFUNC32.DLL", EntryPoint = "mdtyperead", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
	public static extern short mdTypeRead(int Path, short Stno, ref short buf);
	[DllImport("MDFUNC32.DLL", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
	...
	[DllImport("MDFUNC32.DLL", EntryPoint = "mdsendex", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
	public static extern int mdSendEx(int Path, int Netno, int Stno, int Devtyp, int devno, ref int size, ref short buf);
	[DllImport("MDFUNC32.DLL", EntryPoint = "mdreceiveex", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
	...
	[DllImport("MDFUNC32.DLL", EntryPoint = "mddevrstex", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
	public static extern int mdDevRstEx(int Path, int Netno, int Stno, int Devtyp, int devno);
	[DllImport("MDFUNC32.DLL", EntryPoint = "mdrandwex", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
	public static extern int mdRandWEx(int Path, int Netno, int Stno, ref int dev, ref short buf, int bufsiz);
	[DllImport("MDFUNC32.DLL", EntryPoint = "mdrandrex", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
	public static extern int mdRandREx(int Path, int Netno, int Stno, ref int dev, ref short buf, int bufsiz);
	[DllImport("MDFUNC32.DLL", EntryPoint = "mdrembufwriteex", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
	public static extern int mdRemBufWriteEx(int Path, int Netno, int Stno, int Offset, ref int size, ref short data);
	[DllImport("MDFUNC32.DLL", EntryPoint = "mdrembufreadex", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
